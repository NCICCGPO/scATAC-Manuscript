...
fasta_file = "./hg38.fasta" ### TODO: update fasta path
...
def can_job_be_submitted(
    ...
    TODO: Implement according to cluster rules
...
def get_fasta(fasta_file: str = fasta_file):
...
def load_peak_locs(csv_file: str = './uncleaned_motifs/vierstra_Archetype_BRCAagg.csv',
                   chunksize: int = 1e6,
                   verbose: bool = False):
