...
exptroot="/illumina/scratch/deep_learning/akumar22/TCGA/models_250_1364_minibatch_prejitter/blca_samples/"
peakroot="/illumina/scratch/deep_learning/lsundaram/singlecelldatasets/TCGA/peaks_individuals/"
all_cancers = [f'BLCA{x}' for x in range(1,10)] + ['BLCA_control']
