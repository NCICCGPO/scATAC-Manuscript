...
exptroot="/illumina/scratch/deep_learning/akumar22/TCGA/models_250_1364_minibatch_prejitter/gbm_subclone/"
peakroot="/illumina/scratch/deep_learning/lsundaram/singlecelldatasets/TCGA/SubClonal_Identification/"
all_cancers = ["GBM45_cloneA","GBM45_cloneB","GBM39_cloneA","GBM39_cloneB"]
# all_cancers = ["GBM39_cloneA"]
### Fold-wise scripts
