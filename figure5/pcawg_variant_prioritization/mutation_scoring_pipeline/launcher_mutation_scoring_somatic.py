import os
mutations_root="/illumina/scratch/deep_learning/akumar22/TCGA/mutations_scoring/lof_experiments/"
exptroot="/illumina/scratch/deep_learning/akumar22/TCGA/mutations_scoring/lof_experiments/"
...
for c_idx,cancer_name in enumerate(all_cancers):
    mutations_file = f"{mutations_root}/{cancer_name}/{cancer_name}_somatic_inside_peaks.csv"
