...
sumstats=(finngen_r8_C3_BREAST_EXALLC.sumstats.gz brca_gwas_onco_ss_hm3_bcac.sumstats.gz BRCA_PCP_hm3.sumstats.gz) 
                ...
                case $suffix in
                    ...
                    for j in 0 1 2  #four sum stats datasets
                        do
                            ...
                            qsub -cwd -b Y -N ${peakset}_${varset} -l h_vmem=50G "conda activate ldsc; python ~/ldsc/ldsc.py --h2 ${vars} --ref-ld-chr baselineLD.,peaksets_processed/${peakset}_hg37. --frqfile-chr 1000G_Phase3_frq/1000G.EUR.QC. --w-ld-chr 1000G_Phase3_weights_hm3_no_MHC/weights.hm3_noMHC. --overlap-annot --print-coefficients --out brca_ss_vs_all_peaks_v2/${varset}_${peakset}"
